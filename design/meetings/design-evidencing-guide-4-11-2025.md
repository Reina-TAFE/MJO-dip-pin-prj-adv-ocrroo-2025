...
- [ ] Meeting held on [4-11-2025]
- [ ] Persona discussed: [Bill]
- [ ] Design artefacts reviewed: [wireframes]
- [ ] Issues discussed: [Navigation order may be confusing, UI could be condensed.]
- [ ] Feedback provided: [focus on MVP.]

##### What worked well

- [ ] [well defined vision of product, taken user behaviour patterns into account]
...
- [ ] [provide functioning MVP] (no commitment to complete this)
